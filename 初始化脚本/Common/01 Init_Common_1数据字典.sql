...
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( N'ConsultClass', N'TeachConsultation', N'案例教学', N'案例教学', NULL);
-- 影像会诊检查项目
...
INSERT INTO DataDicInfo (LookupKey, DicName, DicCode, DicComment, DicExtend) VALUES (N'ImageReviewDataType', N'CT', '10', N'CT', '1');
INSERT INTO DataDicInfo (LookupKey, DicName, DicCode, DicComment, DicExtend) VALUES (N'ImageReviewDataType', N'MR核磁共振', '11', N'MR核磁共振', '1');
INSERT INTO DataDicInfo (LookupKey, DicName, DicCode, DicComment, DicExtend) VALUES (N'ImageReviewDataType', N'X线', '12', N'X线', '1');
INSERT INTO DataDicInfo (LookupKey, DicName, DicCode, DicComment, DicExtend) VALUES (N'ImageReviewDataType', N'其它影像', '13', N'其它影像类型', '1');
INSERT INTO DataDicInfo (LookupKey, DicName, DicCode, DicComment, DicExtend) VALUES (N'ImageReviewDataType', N'胶片', '20', N'胶片', '1');
INSERT INTO DataDicInfo (LookupKey, DicName, DicCode, DicComment, DicExtend) VALUES (N'ImageReviewDataType', N'光盘', '21', N'光盘', '1');
INSERT INTO DataDicInfo (LookupKey, DicName, DicCode, DicComment, DicExtend) VALUES (N'ImageReviewDataType', N'U盘', '22', N'U盘', '1');
INSERT INTO DataDicInfo (LookupKey, DicName, DicCode, DicComment, DicExtend) VALUES (N'ImageReviewDataType', N'检查报告', '30', N'检查报告', '2');
INSERT INTO DataDicInfo (LookupKey, DicName, DicCode, DicComment, DicExtend) VALUES (N'ImageReviewDataType', N'门诊病历', '31', N'门诊病历', '2');
INSERT INTO DataDicInfo (LookupKey, DicName, DicCode, DicComment, DicExtend) VALUES (N'ImageReviewDataType', N'有效证件（例如：身份证、医保卡、护照、驾驶证等）', '40',N'有效证件（例如：身份证、医保卡、护照、驾驶证等）', '2');
INSERT INTO DataDicInfo (LookupKey, DicName, DicCode, DicComment, DicExtend) VALUES (N'ImageReviewDataType', N'检验报告', '50', N'检验报告', '3');
INSERT INTO DataDicInfo (LookupKey, DicName, DicCode, DicComment, DicExtend) VALUES (N'ImageReviewDataType', N'病理报告', '51', N'病理报告', '3');
INSERT INTO DataDicInfo (LookupKey, DicName, DicCode, DicComment, DicExtend) VALUES (N'ImageReviewDataType', N'住院小结', '54', N'住院小结', '3');
INSERT INTO DataDicInfo (LookupKey, DicName, DicCode, DicComment, DicExtend) VALUES (N'ImageReviewDataType', N'心电图报告', '52', N'心电图报告', '3');
INSERT INTO DataDicInfo (LookupKey, DicName, DicCode, DicComment, DicExtend) VALUES (N'ImageReviewDataType', N'内窥镜检测报告', '53', N'内窥镜检测报告', '3');
...
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( N'ReferralCase', N'AppKey', NULL, N'移动转诊平台Key', NULL);
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( N'ReferralCase', N'AppSecret', NULL, N'移动转诊平台Secret', NULL);
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( N'ReferralCase', N'ApiUrl', NULL, N'移动转正平台接口地址', NULL);


/* 2017-08-28 新增  */
-- MDT会诊类型 MDTConsultKind
insert into DataDicType (LookUpKey, TypeCode, TypeName) VALUES ( N'MDTConsultKind', N'1048', N'MDT会诊类型');
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( N'MDTConsultKind', N'MDTGeneral', N'全科会诊', N'全科会诊(MDT)', NULL);
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( N'MDTConsultKind', N'MDTCIS', N'临床会诊', N'临床会诊(MDT)', NULL);

-- 医生收入等级 DoctorInComeLevel
insert into DataDicType (LookUpKey, TypeCode, TypeName) VALUES ( N'DoctorInComeLevel', N'1049', N'医生收入等级');
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( N'DoctorInComeLevel', N'10', N'黄金级', N'黄金级', NULL);
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( N'DoctorInComeLevel', N'20', N'红宝石级', N'红宝石级', NULL);
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( N'DoctorInComeLevel', N'30', N'翡翠级', N'翡翠级', NULL);
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( N'DoctorInComeLevel', N'40', N'钻石级', N'钻石级', NULL);



/* 2017-09-04 新增  */
-- 服务中心自身诊断制度 ServiceCenterDiagnosisRule
insert into DataDicType (LookUpKey, TypeCode, TypeName) VALUES ( 'ServiceCenterDiagnosisRule', '1051', N'诊断制度');
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( 'ServiceCenterDiagnosisRule', 'DoubleSignature', N'双签名', N'双签名', NULL);
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( 'ServiceCenterDiagnosisRule', 'FinalJudgment', N'终审制', N'终审制', NULL);


-- 服务中心工作方式 ServiceCenterWorkingMode
insert into DataDicType (LookUpKey, TypeCode, TypeName) VALUES ( 'ServiceCenterWorkingMode', '1052', N'工作方式');
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( 'ServiceCenterWorkingMode', 'OnDuty', N'坐班制', N'坐班制（固定排班模式）', NULL);
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( 'ServiceCenterWorkingMode', 'OrderTaking', N'接单制', N'接单制（上线开始接单）', NULL);
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( 'ServiceCenterWorkingMode', 'Receive', N'领取制', N'领取制（医生主动领取任务）', NULL);
...
insert into DataDicType (LookUpKey, TypeCode, TypeName) VALUES ( 'CollectionServiceDataSource', '1058', N'采集服务来源');
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( 'CollectionServiceDataSource', 'IMCIS', N'临床信息集成融合平台', N'临床信息集成融合平台', NULL);
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( 'CollectionServiceDataSource', 'IDCAS', N'云归档', 'IDCAS', NULL);
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( 'CollectionServiceDataSource', 'eWorldRISV4.5', 'eWorldRISV4.5', N'放射4.5', NULL);
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( 'CollectionServiceDataSource', 'eWorldXIS3.2', 'eWorldXIS3.2', N'特检3.2', NULL);
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( 'CollectionServiceDataSource', 'SMP', N'SMP采集服务', N'SMP采集工具', NULL);
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( 'CollectionServiceDataSource', 'Other', N'其他', N'其他', NULL);


-- 代理IP映射 AgentIpMapping
insert into DataDicType (LookUpKey, TypeCode, TypeName) VALUES ( 'AgentIpMapping', 'AgentIpMapping', N'代理IP映射');
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( 'AgentIpMapping', '192.168.2.153', '192.168.1.202', N'代理IP转换', NULL);

/* 2018-01-02 新增 转诊相关的参数 */
-- 性别 SexKind
insert into DataDicType (LookUpKey, TypeCode, TypeName) VALUES ( 'SexKind', 'SexKind', N'性别');
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( 'SexKind', N'0', N'未知', N'未知的性别', NULL);
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( 'SexKind', N'1', N'男性', N'男性', NULL);
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( 'SexKind', N'2', N'女性', N'女性', NULL);
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( 'SexKind', N'5', N'女性改（变）为男性', N'女性改（变）为男性', NULL);
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( 'SexKind', N'6', N'男性改（变）为女性', N'男性改（变）为女性', NULL);
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( 'SexKind', N'9', N'未说明', N'未说明的性别', NULL);

-- 年龄单位 AgeUnitKind
insert into DataDicType (LookUpKey, TypeCode, TypeName) VALUES ( 'AgeUnitKind', N'AgeUnitKind', N'年龄单位');
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( 'AgeUnitKind', N'Year', N'岁', N'岁', NULL);
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( 'AgeUnitKind', N'Month', N'月', N'月', NULL);
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( 'AgeUnitKind', N'Week', N'周', N'周', NULL);
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( 'AgeUnitKind', N'Day', N'天', N'天', NULL);
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( 'AgeUnitKind', N'Hour', N'时', N'时', NULL);
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( 'AgeUnitKind', N'Minute', N'分', N'分', NULL);

-- 婚姻状况 MarryKind
insert into DataDicType (LookUpKey, TypeCode, TypeName) VALUES ( 'MarryKind', N'MarryKind', N'婚姻状况');
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( 'MarryKind', N'1', N'未婚', N'未婚', NULL);
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( 'MarryKind', N'2', N'已婚', N'已婚', NULL);
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( 'MarryKind', N'3', N'丧偶', N'丧偶', NULL);
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( 'MarryKind', N'4', N'离异', N'离异', NULL);
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( 'MarryKind', N'5', N'其他', N'其他', NULL);

-- 门诊类型 ClinicKind
insert into DataDicType (LookUpKey, TypeCode, TypeName) VALUES ( 'ClinicKind', N'ClinicKind', N'门诊类型');
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( 'ClinicKind', N'100', N'普通门诊', N'普通门诊', NULL);
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( 'ClinicKind', N'101', N'专科门诊', N'专科门诊', NULL);
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( 'ClinicKind', N'102', N'专家门诊', N'专家门诊', NULL);
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( 'ClinicKind', N'103', N'特需门诊', N'特需门诊', NULL);
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( 'ClinicKind', N'104', N'专病门诊', N'专病门诊', NULL);
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( 'ClinicKind', N'999', N'其他', N'其他', NULL);

-- 费用类别 FeeKind
insert into DataDicType (LookUpKey, TypeCode, TypeName) VALUES ( 'FeeKind', N'FeeKind', N'费用类别');
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( 'FeeKind', N'1', N'自费', N'自费', NULL);
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( 'FeeKind', N'2', N'医保', N'医保', NULL);


-- 病情分级 DiseaseLevel   (包括了等级、标准、病情严重程度 急诊分区)
insert into DataDicType (LookUpKey, TypeCode, TypeName) VALUES ( 'DiseaseLevel', N'DiseaseLevel', N'病情分级');
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( 'DiseaseLevel', N'A', N'1级', N'濒危病人', N'红色');
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( 'DiseaseLevel', N'B', N'2级', N'危重病人', N'红色');
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( 'DiseaseLevel', N'C', N'3级', N'急症病人', N'黄色');
insert into DataDicInfo (  LookUpKey, DicCode, DicName, DicComment, DicExtend) VALUES ( 'DiseaseLevel', N'D', N'4级', N'非急症病人', N'绿色');
/*  ************************************************************** */
