...
namespace eWorld.EMPI.Server.ServerControler
{
    public class QuartzServerConfig
    {
        ...
        private const string DefaultServiceName = "eWorld.EMPI";
        private const string DefaultServiceDisplayName = "eWorld.EMPI";
        private const string DefaultServiceDescription = "eWorld.EMPI";
